...
### `git clone https://github.com/zichenma/sales_management_frontend.git`
...
Start React Application Locally (please make sure sales management backend is runing before start front end): 
